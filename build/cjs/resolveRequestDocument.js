...
const kinds_js_1 = require("graphql/language/kinds.js");
...
const extractOperationName = (document) => {
    ...
    const operationDefinitions = document.definitions.filter((definition) => definition.kind === kinds_js_1.Kind.OPERATION_DEFINITION);
